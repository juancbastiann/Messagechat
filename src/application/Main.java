...
public class Main extends Application {
    ...
    public void start(Stage stage1) throws Exception { 	
    	...
    	stage1.getIcons().add(new Image("https://cdn-icons-png.flaticon.com/512/9204/9204122.png"));
    	...
    	firstgui.getIniciar().setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				if(usuarios.password(firstgui.getUsertext().getText(), firstgui.getClavetext().getText()) == null) {
					...
					stage3.getIcons().add(new Image("https://cdn-icons-png.flaticon.com/512/9204/9204122.png"));
